...
public class DList {
	...
	public void reversePop() {
	 ...
	 public void removeDuplicates() {
		...
		DNode compare = current.getNext();
		int k = 0;
		for (int i = 0; i < size; i++) {
			//DNode current = header.getNext();
			//System.out.println("Loop");													//Debug line
			//System.out.println(current.getElement());										//Debug line
			//System.out.println(compare.getElement());										//Debug line
			for (int j = k; j < size; j++) {
				//System.out.println(current.getElement() + " vs " + compare.getElement());	//Debug line
				if (current.getElement().equals(compare.getElement())) {
					
					//System.out.println("removed " + compare.getElement());				//Debug line
					remove(compare);
					compare = current.getNext();
					//System.out.println("New " + compare.getElement());					//Debug line
				}
